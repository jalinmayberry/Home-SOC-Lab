...
1. Start by getting your Raspberry Pi’s situated. I’d recommend utilizing [Raspberry Pi Imager](https://www.raspberrypi.com/software/) 
    ...
    ![RPOS Imaging.jpg](RPOS_Imaging.jpg)
...
8. Visit [https://cribl.io/download/](https://cribl.io/download/) (We are downloading the Edge and Stream suite)
    
    ![image.png](image%202.png)
    
    1. curl -Lso - $(curl [https://cdn.cribl.io/dl/latest-arm64](https://cdn.cribl.io/dl/latest-arm64)) | tar zxv
